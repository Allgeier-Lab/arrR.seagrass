# Contributing to **arrR.seagrass**

This outlines how to propose a change to **arrR.seagrass**. There are several ways you can contribute to this project. If you want to know more about why and how to contribute to open source projects like this one, see this [Open Source Guide](https://opensource.guide/how-to-contribute/).

#### Code of Conduct

Please note that the **arrR.seagrass** project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md). By contributing to this project you agree to abide by its terms.

## How to contribute

### Ask a question :interrobang:

Browse the [documentation](https://allgeier-lab.github.io/arrR.seagrass/) to see if you can find a solution. Still stuck? Open an [issue on GitHub](https://github.com/Allgeier-Lab/arrR.seagrass/issues) on GitHub. We'll try to do our best to address it, as questions often lead to better documentation or the discovery of bugs.
...
Take a look at the [documentation](https://allgeier-lab.github.io/arrR.seagrass/) and [issue on GitHub](https://github.com/Allgeier-Lab/arrR.seagrass/issues) list to see if it isn't included or suggested yet. If not, please open a new issue!
...
Report it as an [issue on GitHub](https://github.com/Allgeier-Lab/arrR.seagrass/issues) so we can fix it. A good bug report makes it easier for us to do so, so please include:
...
1. Fork [the repo](https://github.com/Allgeier-Lab/arrR.seagrass) and clone it to your computer. To learn more about this process, see [this guide](https://guides.github.com/activities/forking/). Don't forget to pull all new changes before starting to work!
